...
public class SiteService extends BaseService {
	 ...
	 * @throws CRUDException
	 */
	public List<Site> findAllSiteList(Site site) throws CRUDException {
		return siteMapper.findAllSiteList(site);
	}
	 ...
	 * @throws CRUDException
	 */
	public int findSiteTotal(Site site) throws CRUDException {
		return siteMapper.findSiteTotal(site);
	}
