  ...
  <body>
 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
        <form id="dataForm" method="post">
			...
			<div class="fitem">
                <label>描述</label>
                <input id="description" name="description" class="easyui-textbox" data-options="required:true,tipPosition:'top'"/>
			...
			<div class="fitem">
                <label>父级字典</label>
                <input id="parentId" name="parentId" class="easyui-combotree" data-options="readonly:true,required:true,tipPosition:'top'" style="width:160px;" url="${ctx}/sys/dict/tree"/>
