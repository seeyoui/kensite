...
public class SiteController extends BaseController {
	...
	public ModelAndView showSitePageList(HttpSession session,
		...
		return new ModelAndView("framework/cms/site/site", modelMap);
	}
	...
	public String getAllListData(HttpSession session,
			HttpServletResponse response, HttpServletRequest request,
			ModelMap modelMap, Site site) throws Exception{
		List<Site> siteList = siteService.findAllSiteList(site);
		JSONArray jsonObj = JSONArray.fromObject(siteList);
		RequestResponseUtil.putResponseStr(session, response, request, jsonObj);
		return null;
	}
