...
#webFooterTable {
	background: #000
		url(./image/demo/ABUIABACGAAg_5jFrgUosLbshAcw8w44_gE.jpg) repeat
		center;
}
...
#webBanner .bannerLeft {
	background: none;
}

#webBanner .bannerRight {
	background: none;
}
...
<body class="g_bodyManage g_locale2052 g_cusSiteWidth">
	...
	<div id="styleDesign" class="g_styleDesign g_editPanel">
		<div class="tabsWrap">
			<ul id="tabs" class="tabs">
				...
				<li><a id="webTemplateTab" class="tabsMenu" href="javascript:;"
					onfocus="this.blur()"
					onclick="Site.webTemplateTabClick2();return false;"> 网站主题 </a></li>
				<li style=""><a class="tabsMenu" href="javascript:;"
					onfocus="this.blur()" id="webBannerTab"
					onclick="Site.webBannerTabClick();return false;"> 网站横幅 </a></li>
				<li><a class="tabsMenu" href="javascript:;"
					onfocus="this.blur()" id="pageLayoutTab"
					onclick="Site.pageLayoutTabClick();return false;"> 页面版式 </a></li>
				<li> <a class="tabsMenu" href="javascript:;" 
					onfocus="this.blur()" id="webSettingTab"
					onclick="Site.webSettingTabClick();return false;"> 网站设置 </a></li>
				<!--
          <li>
		  ...
		  -->
				<li style="text-align: right;" id="styleDesignBtnContainer"
					class="styleDesignBtnContainer-five"><a href="javascript:;"
					onclick="Site.toggleSetWebTemplateTab();return false;"
					class="J_webTemplateTabSwitch fk-webTemplateTabSwitch"> </a> <a
					href="javascript:;" class="cancelBtn"
					onclick="Site.closeStyleDesign();return false"> 取&nbsp;消 </a> <a
					href="javascript:;" id="saveButton" class="saveBtn buttonDisabled"
					onclick="Site.saveStyle();return false;"> <span
						class="saveIcon"> </span> <span class="saveText">
							保&nbsp;&nbsp;存 </span>
				</a></li>
				<li>
		...
		<div id="panes" class="panes">
			<div id="webTemplate" class="webTemplate">
				<iframe id="webTemplateFrame" scrolling="auto" frameborder="0" height="205px" width="100%"></iframe>
			</div>
			<div id="webBannerStyle" class="funcModule">
				<iframe id="webBannerFrame" scrolling="auto" frameborder="0" height="205px" width="100%"></iframe>
			</div>
			<div id="pageLayout" class="funcModule">
				<iframe id="pageLayoutFrame" scrolling="auto" frameborder="0" height="205px" width="100%"></iframe>
			</div>
			<div id="webSetting" class="funcModule">
				<iframe id="webSettingFrame" scrolling="auto" frameborder="0" height="205px" width="100%"></iframe>
			</div>
			<div id="baiduOpt" class="funcModule">
				<iframe id="baiduOptFrame" scrolling="auto" frameborder="0" height="205px" width="100%"></iframe>
			</div>
		</div>
	...
	<div id="g_main" class='g_main g_col2 g_mainManage' style='top: 44px'>
		<div id="web" class="g_web g_webManage">
					...
					<td align="center">
						<div id="webTop" class="webTop">
							<div id='corpTitle' class='corpTitle corpTitle2'
								fontPatternTitle='false' style='' _linkType='0'>
								<div id='primaryTitle' style=''></div>
							...
							<div id='logo' class='logo logo2' style='top: 65px; left: 58px;'>
								<a id='logoLink' hidefocus='true' class='link-p'
									...
									id='logoImg' title='智慧星河' alt='智慧星河' style='float: left;'
									height='50' width='187'
									src='${ctx_web}/image/demo/ABUIABAEGAAg6ua7rgUoyMTtRDC7ATgy.png' />
								</a>
							</div>
						</div>
					</td>
			...
			<table class="webNavTable" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center">
						<div id="webNav" class="webNav webNavDefault"></div>
					</td>
				</tr>
			</table>
																...
																<div id='navCenter' class='navCenter'
																	...
																	<div class='itemContainer'>
																		<table title='' class='item itemCol2 itemIndex1'
																			...
																			<tr>
																				...
																				<td class='itemCenter'><a hidefocus='true'
																					style='outline: none;' href='/' target='_self'
																					onclick='return false;'> <span
																						class='itemName0'> 首页 </span>
																				</a></td>
																		...
																		<table title='' class='item itemCol103 itemIndex2'
																			...
																			id='nav103'
																			onclick='Site.redirectUrl("/col.jsp?id=103", "_self", event, 1, 0);'
																			_jump='window.open("/col.jsp?id=103", "_self")'>
																			<tr>
																				<td class='itemLeft'></td>
																				<td class='itemCenter'><a hidefocus='true'
																					style='outline: none;' href='/col.jsp?id=103'
																					target='_self' onclick='return false;'> <span
																						class='itemName0'> 我们的服务 </span>
																				</a></td>
																				<td class='itemRight'></td>
																			</tr>
																		</table>
																		...
																		<table title='' class='item itemCol21 itemIndex3'
																			...
																			<tr>
																				<td class='itemLeft'></td>
																				<td class='itemCenter'><a hidefocus='true'
																					style='outline: none;' href='/nr.jsp'
																					target='_self' onclick='return false;'> <span
																						class='itemName0'> 新闻动态 </span>
																				</a></td>
																				<td class='itemRight'></td>
																			</tr>
																		</table>
																		<div class='itemSep'></div>
																		<table title='' class='item itemCol101 itemIndex4'
																			cellpadding='0' cellspacing='0' colId='101'
																			id='nav101'
																			...
																			<tr>
																				<td class='itemLeft'></td>
																				<td class='itemCenter'><a hidefocus='true'
																					style='outline: none;' href='/col.jsp?id=101'
																					target='_self' onclick='return false;'> <span
																						class='itemName0'> 关于我们 </span>
																				</a></td>
																				<td class='itemRight'></td>
																			</tr>
																		</table>
																		<div class='itemSep'></div>
																		<table title='' class='item itemCol102 itemIndex5'
																			cellpadding='0' cellspacing='0' colId='102'
																			id='nav102'
																			...
																			<tr>
																				<td class='itemLeft'></td>
																				<td class='itemCenter'><a hidefocus='true'
																					style='outline: none;' href='/col.jsp?id=102'
																					target='_self' onclick='return false;'> <span
																						class='itemName0'> 联系我们 </span>
																				</a></td>
																				<td class='itemRight'></td>
																			</tr>
																		</table>
																		<div class='itemSep'></div>
																		<table title='' class='item itemCol9 itemIndex6'
																			...
																			<tr>
																				<td class='itemLeft'></td>
																				<td class='itemCenter'><a hidefocus='true'
																					style='outline: none;' href='/msgBoard.jsp'
																					target='_self' onclick='return false;'> <span
																						class='itemName0'> 留言板 </span>
																				</a></td>
																				<td class='itemRight'></td>
																			</tr>
																		</table>
								...
								<tr>
									...
									<td class="bannerCenter" align='center' valign='top'>
										...
										<div id='banner' class='banner extBanner'
											style='background:url(${ctx_web}/image/demo/ABUIABACGAAgia3GrgUokPy2zQcwoAs4wgM.jpg) 50% 50% no-repeat;height:450px'
											...
											<td class="middleCenter" align="center">
												<div class="footerContent">
																		...
																		<tr>
																			<td class='footerItemContainer-firstTd'>
																				<div class='footerItemPic'>
																					<a href='javascript:;'
																						class='footerItemNormalPic  stopPropagation footerItemAddPic'
																						id='footerItemPic2'
																						onclick='Site.addFooterItemImg("2");return false;'>
																					</a>
																				</div>
																			</td>
																			<td class='footerItemContainer-secondTd'>
																				<div class='footerItemContent'>
																					<div class='footerItemTop'>
																						<a title='' class='footerItemTopLink' href='/'
																							child='0'> 首页 </a>
																					</div>
													...
													<div class="footerInfo">
														...
														<p>
															<font face="Arial"> © </font> 2015 广告创意 版权所有
														</p>
														<p style="line-height: 2.5em;">
															<br />
														</p>
														<p>
															友情链接： <a href="http://www.baidu.com" target="_blank"
																title="百度" _t="103" _i="http://www.baidu.com"
																_n="www.baidu.com" style="text-decoration: none;">
																百度 </a> | <a href="http://www.google.cn" target="_blank"
																title="谷歌" _t="103" _i="http://www.google.cn"
																_n="www.google.cn" style="text-decoration: none;">
																谷歌 </a> | <span style="line-height: 21px;"> 品牌设计|
																平面设计| 活动策划| 展厅设计 </span>
														</p>
														<p>
															<br />
													...
													<div class="footerSupport">
														<span class='footerFaisco'> 技术支持： <a
															...
															onclick='Site.logDog(100065, 0);' target='_blank'>
																凡科建站 </a>
														</span> <span class="bgplayerButton" id="bgplayerButton"
	...
	<div id="siteRenewNotice_box" class="siteRenewNotice_box">
		...
		<div class="siteRenewNotice_middle">
			...
			<div class="siteRenewNotice_bottom"></div>
		</div>
	</div>
	...
	<script type="text/javascript">
			...
			Site
					.initBannerManage([
							...
							},
							{
								...
								"evalScript" : "Site.logDog(100041, 7); Site.popupWindow({title:'设置横幅切换动画', frameSrcUrl:'${ctx_web}/manage/styleBannerSetting.jsp?ram='+Math.random(), width:690, height:562, saveBeforePopup:false});"
							},
							{
								"id" : "btn-editBanner",
								"display" : "text",
					...
					.initNavList([
							{
								"operationText" : "新增栏目",
								"display" : "text",
								"evalScript" : "Site.popupWindow({title:'新增栏目', frameSrcUrl:'${ctx_web}/manage/colEdit.jsp?ram='+Math.random(), width:'425', height:'240', beforePopup:true});"
							},
							{
								"operationText" : "管理栏目",
								"display" : "text",
								"evalScript" : "Site.popupWindow({title:'管理栏目', frameSrcUrl:'${ctx_web}/manage/nav.jsp?ram='+Math.random(), width:'675', height:'450', beforePopup:true});"
							},
							{
								"operationText" : "设置样式",
								"display" : "text",
								"evalScript" : "Site.popupWindow({title:'设置导航栏样式', frameSrcUrl:'${ctx_web}/manage/navStyleEdit.jsp?ram='+Math.random(), width:'490', height:'330', saveBeforePopup:false});"
							},
							{
								"display" : "text",
								"operationText" : "隐藏",
					...
					.initFooterManage([
							{
								"operationText" : "编辑内容",
								"display" : "text",
								"evalScript" : "Site.popupWindow({title:'编辑底部内容', frameSrcUrl:'${ctx_web}/manage/footerInfoEdit.jsp?ram='+Math.random(), width:'710', height:'500'});"
							}, {
								"operationText" : "底部样式",
								"display" : "text",
					...
					.initCorpTitleManage([
							{
								...
								"className" : "edit",
								"evalScript" : "Site.popupWindow({title:'编辑网站标题', frameSrcUrl:'${ctx_web}/manage/corpTitleEdit.jsp?ram='+Math.random(), width:'403', height:'300', saveBeforePopup:false});"
							},
							{
								"display" : "text",
								"operationText" : "隐藏",
					...
					.initLogoManage([
							{
								...
								"className" : "edit",
								"evalScript" : "Site.popupWindow({title:'编辑LOGO', frameSrcUrl:'${ctx_web}/manage/corpTitleEdit.jsp?ram='+Math.random()+'&_tabs=2', width:'403', height:'300', opacity:'0.2', saveBeforePopup:false});"
							},
							{
								"display" : "text",
								"operationText" : "隐藏",
		...
		var _wideNav = 0;
		var _templateType = 0;
		var _templateBannerId = 10005;//styleBanner.jsp==bannerList==生成主题默认横幅
		...
		var _titleData = {
			...
			"jm" : {//跳转方式
				"y" : 2,//0不跳转 2自定义链接
				"f" : "http://www.seeyoui.com",//地址文本input
				"jType" : 103,//100栏目    101产品    102文章    108图册    106产品分类    107文章分类    103自定义
				"ot" : 0,//链接打开方式 <option value="1">当前窗口</option><option value="2">新窗口</option>
				"jUrl" : "http://www.seeyoui.com",//地址跳转使用
				"jName" : "http://www.seeyoui.com"//地址名称--自定义的同上
			},
			"h" : false,//是否隐藏
			"t" : -1,//top
			"l" : -1,//left
		...
		var _logoData = {
			...
			"lt" : 0,//link-text
			"addr" : "",//链接地址
			"ot" : 1,//链接打开方式 <option value="1">当前窗口</option><option value="2">新窗口</option>
			"p" : "${ctx_web}/image/demo/ABUIABAEGAAg6ua7rgUoyMTtRDC7ATgy.png"//图片路径
		}; // 当前页面的数据
		...
		var _panelOptionData = {
			...
			"selectOptionList" : [ "<option value='2'>首页<\/option>",
					...
					"<option value='17'>会员注册<\/option>",
					"<option value='-1'>[会员栏目]<\/option>",
					"<option value='17'>┣&nbsp;会员注册<\/option>",
					"<option value='18'>┣&nbsp;会员登录<\/option>",
					"<option value='19'>┣&nbsp;会员资料<\/option>",
					"<option value='24'>┗&nbsp;会员中心<\/option>",
					"<option value='-2'>[商城栏目]<\/option>",
					"<option value='13'>┣&nbsp;购物车<\/option>",
					"<option value='14'>┣&nbsp;订单结算<\/option>",
					"<option value='15'>┣&nbsp;订单列表<\/option>",
					"<option value='16'>┗&nbsp;订单详情<\/option>",
					"<option value='-3'>[特殊栏目]<\/option>",
					"<option value='7'>┣&nbsp;文章详情<\/option>",
					"<option value='8'>┣&nbsp;产品详情<\/option>",
					"<option value='10'>┣&nbsp;图片详情<\/option>",
					"<option value='20'>┣&nbsp;投票结果<\/option>",
					"<option value='22'>┣&nbsp;图册目录结果<\/option>",
					"<option value='23'>┗&nbsp;全站搜索结果<\/option>",
					"<option value='-9'>[未使用的模块]<\/option>" ],
			"moduleIconClassList" : [ {
				"style" : 1,
				"className" : "rich"
			}, {
	...
	<script type="text/javascript">
		...
		*/
		...
		$LAB.script("${ctx_web}/js/imageEffect.min.js?v=201601131153").wait(
				function() {
		...
		$LAB.script("${ctx_web}/js/siteTemplates.min.js?v=201512221730")
				.script("${ctx_web}/js/faiSettingPanel.min.js?v=201512292011");

		$LAB
				.script("${ctx_web}/js/faiFloatPanel.min.js?v=201512281739")
				.script(
						"${ctx_web}/js/faiFloatPanel_bindEvent.min.js?v=201601121610")
				.wait(function() {
