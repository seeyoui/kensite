...
(
	...
	copyright clob,
	customview varchar2(255),
	createuser varchar2(64),
	createdate date,
	updateuser varchar2(64),
	updatedate date,
	remarks varchar2(255),
	delflag char(1) DEFAULT '0' NOT NULL,
	PRIMARY KEY (id)
);
...
CREATE INDEX cms_article_createuser ON cms_article (createuser);
...
CREATE INDEX cms_article_updatedate ON cms_article (updatedate);
...
CREATE INDEX cms_link_createuser ON cms_link (createuser);
CREATE INDEX cms_link_updatedate ON cms_link (updatedate);
...
COMMENT ON COLUMN cms_article.weightdate IS '权重期限';
...
COMMENT ON COLUMN cms_article.createuser IS '创建者';
COMMENT ON COLUMN cms_article.createdate IS '创建时间';
COMMENT ON COLUMN cms_article.updateuser IS '更新者';
COMMENT ON COLUMN cms_article.updatedate IS '更新时间';
...
COMMENT ON COLUMN cms_category.createuser IS '创建者';
COMMENT ON COLUMN cms_category.createdate IS '创建时间';
COMMENT ON COLUMN cms_category.updateuser IS '更新者';
COMMENT ON COLUMN cms_category.updatedate IS '更新时间';
...
COMMENT ON COLUMN cms_comment.auditdate IS '审核时间';
...
COMMENT ON COLUMN cms_guestbook.createdate IS '留言时间';
...
COMMENT ON COLUMN cms_link.weightdate IS '权重期限';
COMMENT ON COLUMN cms_link.createuser IS '创建者';
COMMENT ON COLUMN cms_link.createdate IS '创建时间';
COMMENT ON COLUMN cms_link.updateuser IS '更新者';
COMMENT ON COLUMN cms_link.updatedate IS '更新时间';
...
COMMENT ON COLUMN cms_site.customview IS '自定义站点首页视图';
COMMENT ON COLUMN cms_site.createuser IS '创建者';
COMMENT ON COLUMN cms_site.createdate IS '创建时间';
COMMENT ON COLUMN cms_site.updateuser IS '更新者';
COMMENT ON COLUMN cms_site.updatedate IS '更新时间';
COMMENT ON COLUMN cms_site.remarks IS '备注信息';
COMMENT ON COLUMN cms_site.delflag IS '删除标记';
