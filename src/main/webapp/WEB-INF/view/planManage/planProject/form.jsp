	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post">
				<div class="fitem">
					<ks:formTag table="PLAN_PROJECT" column="REMARKS"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_PROJECT" column="NAME"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_PROJECT" column="LEADER"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_PROJECT" column="TEAM_ID"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_PROJECT" column="DESCRIBE"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_PROJECT" column="STATUS"/>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				url = '${ctx}/planManage/planProject/save';
				if(row != null) {
					$('#dataForm').form('load', row);
					url = '${ctx}/planManage/planProject/update';
				}
			});
