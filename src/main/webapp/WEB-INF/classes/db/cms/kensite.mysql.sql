...
(
	...
	weightdate datetime COMMENT '权重期限',
...
CREATE INDEX cms_article_createuser ON cms_article (createuser ASC);
...
CREATE INDEX cms_article_updatedate ON cms_article (updatedate ASC);
...
CREATE INDEX cms_link_createuser ON cms_link (createuser ASC);
CREATE INDEX cms_link_updatedate ON cms_link (updatedate ASC);
