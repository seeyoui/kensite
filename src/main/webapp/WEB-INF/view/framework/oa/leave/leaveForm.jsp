								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" id="leaveType_id" name="leaveType" ${state}>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="startTime_id" name="startTime" value="<fmt:formatDate value="${leave.startTime}" type="both"/>" placeholder="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:false});" ${state}>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="field-2" class="control-label">请假结束时间</label>
											<input type="text" class="form-control" id="endTime_id" name="endTime" value="<fmt:formatDate value="${leave.endTime}" type="both"/>" placeholder="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:false});" ${state}>
										</div>
									</div>
								</div>
								<div class="row">
