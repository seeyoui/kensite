	...
	<body>
	 	<div style="position:absolute;top:10px;left:20px;right:20px;bottom:10px;">
			<form id="dataForm" method="post">
				<div class="fitem">
					<ks:formTag table="PLAN_TEAM" column="REMARKS"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_TEAM" column="NAME"/>
				</div>
				<div class="fitem">
					<ks:formTag table="PLAN_TEAM" column="DESCRIBE"/>
				</div>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				url = '${ctx}/planManage/planTeam/save';
				if(row != null) {
					$('#dataForm').form('load', row);
					url = '${ctx}/planManage/planTeam/update';
				}
			});
